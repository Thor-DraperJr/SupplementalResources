...
### Manage access to the Azure Key Vault.
...
Explain the basic concepts that are necessary to manage keys and configure key rotation in the Azure Key Vault.

Understand how to manage keys and configure key rotation in the Azure Key Vault.
...
Explain the basic concepts that are necessary to work with security principals in the Azure Active Directory.

Understand how to create and secure a security principal in the Azure Active Directory.
...
Explain the basic concepts that are necessary to secure the connectivity of virtual networks connectivity with VPNs in the Azure Portal.

Identify the different VPN design options that can be used to secure the connectivity of virtual networks connectivity in the Azure Portal.
...
Explain the basic concepts that are necessary to work with a WAF in the Azure Portal.

Understand the three distinct ways that can be used to create a WAF and associate it with an Azure Application Gateway in the Azure Portal.
...
Explain the basic concepts that are necessary to work with an Azure Bastion host in the Azure Portal.

Understand how to deploy an Azure Bastion host in the Azure Portal.

Use an Azure Bastion Host to securely access one or more VMs running in the Azure Portal.
...
Explain the basic concepts that are necessary to work with Service Endpoints in the Azure Portal.

Understand how to deploy a Service Endpoint in the Azure Portal.

Use an Azure Storage Service Endpoint and Service Endpoint Policy to provide granular access control for virtual network traffic to Azure Storage when connecting over a service endpoint.
...
Explain the basic concepts that are necessary to work with DDoS Protection plans in the Azure Portal.

Understand how to deploy a DDoS Protection Plan in the Azure Portal.
...
Explain the basic concepts that are necessary to work with shared access policies in the Azure Portal.

Understand how to deploy a shared access policy for a blob from PowerShell.
